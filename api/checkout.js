...
const PRODUCTS = [
  ...
  { name: "24K Gold Healing Glow Serum", cat: "cream" },
  { name: "Yeast Collagen Firming Peel", cat: "cream" },
  { name: "Golden Firm & Lift Serum", cat: "cream" },
  ...
  { name: "Snail Mucin Repair", cat: "mask" },
  { name: "Honey Restore", cat: "mask" },
  ...
  { name: "Grape \u2013 Firm & Bright", cat: "mask" },
  { name: "Pomegranate \u2013 Antioxidant Glow", cat: "mask" },
  { name: "Golden Renewal Ritual", cat: "mask" },
